...
public interface Cell {
	...
	/**
	 * Método chamado na expansăo da célula vazia sobre
	 * as células adjacentes.
	 *
	 * @param board   Tabuleiro.
	 * @param line    Linha da célula adjacente ŕ célula vazia.
	 * @param column  Coluna da célula adjacente ŕ célula vazia.
	 */
	int expand(Board board, int line, int column);
